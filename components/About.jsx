        ...
        <div className="grid lg:grid-cols-[45fr_55fr] gap-8 lg:gap-16 items-center">
          ...
          <MotionReveal>
            ...
            <p className="mt-5 text-base text-[#555] leading-[1.8] max-w-[480px]">
              Shree Shyam Dairy Farm ki shurwaat ek sapne ke saath hui — logon
              tak shuddh, taaza aur poshtik dairy products pahunchane ke. Hum
              apne farm par gaayon ki dekhbhal pure pyaar aur vaigyanik tarike
              se karte hain, taaki aapko mile sabse behtar doodh aur dairy
              products.
            </p>
