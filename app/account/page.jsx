...
const QUICK_LINKS = [
  { href: "/account/orders", label: "Track Orders", icon: Package, desc: "View current & past orders" },
  { href: "/account/subscriptions", label: "Milk Subscription", icon: Repeat, desc: "Daily fresh milk delivery" },
  { href: "/account/addresses", label: "Addresses", icon: MapPin, desc: "Manage delivery locations" },
