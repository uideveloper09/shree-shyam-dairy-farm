      ...
      <div className={CONTAINER}>
        ...
        <div className="space-y-4 sm:space-y-5">
          <div className="grid gap-4 sm:gap-5 lg:grid-cols-2">
            <Shimmer className="min-h-[280px] rounded-2xl sm:min-h-[300px]" />
            <Shimmer className="min-h-[260px] rounded-2xl sm:min-h-[300px]" />
          </div>
          <Shimmer className="h-56 rounded-2xl sm:h-48" />
        </div>
      </div>
    </section>
  );
